...
const UpdateBookDetails = () => {
    ...
    useEffect(() => {
        const fetch = async () => {
            try {
                const response = await axios.get(`http://localhost:5002/api/v1/get-book-by-id/${id}`, { headers });
    ...
    const submit = async () => {
        try {
            const response = await axios.put(`http://localhost:5002/api/v1/update-book`, bookData , { headers });
